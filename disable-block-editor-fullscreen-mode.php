 ...
 */
define( 'DISABLE_BLOCK_EDITOR_FULLSCREEN_MODE_VERSION', '1.0.0' );
...
function dbef_errormsg () {
	...
	$message = __( 'Error you did not meet the WordPress minimum version 5.4', 'text-domain' );
